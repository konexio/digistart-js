...
console.log("my name" + firstName "est de type" + typeof firstName);
console.log("my age" + age "est de type" + typeof age)
console.log("like" + LikeFootball "est de type" typeof LikeFootball)
console.log("stuff" + otherStuff " est de type" typeof otherStuff)

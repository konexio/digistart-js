...
console.log("monPrénom," + firstName + " est de type" + typeof firstName);
console.log("my Age" + age + "est de type" + typeof age);
console.log("J'aime le football : " + likeFootball + "est la variable de type : " + boolean);
console.log(" Ma variable otherStuff')

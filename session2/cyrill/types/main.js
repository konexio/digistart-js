...
console.log("Mon affinité pour le football" , likeFootball, "est de type" , likeFootball);
console.log("Mon autre chose" , otherStuff , "est de type" , otherStuff);

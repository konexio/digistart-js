...
console.log("mon affinité pour le football", likeFootball, "est de type", typeof likeFootball);
console.log("mon autre chose", otherStuff, "est de type", typeof otherStuff);

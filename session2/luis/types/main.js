...
console.log("mon prénom", firtname, "est de type", typeof firstname);
console.log("mon age", age, "est de type", typeof age)
console.log("J'aime,", likeFootball, "est de type", typeof likeFootball);
console.log("Autre truc,", otherStuff, "est de type", typeof otherStuff);
...
on otient 105 car lordinateur concatene la string 10avec la string 5 pour produire la string 105

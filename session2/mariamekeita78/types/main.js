...
console.log(firstName + " " + typeof (likeFootball));
console.log(firstName + " " + typeof (otherStuff));
...
console.log("my value=" + myNumber + "de type" + typeof(myNumber));

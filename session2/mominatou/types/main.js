...
var;
// nunull// nunull// nunull// nunull//Stuff ther
...
// TODO: ÉTAPE 5
// Que remarque-t-on ? Est-ce le type et le résultat attendu ? Pourquoi ?io// Que remarque-t-on ? Est-ce le type et le résultat attendu ? Pourquoi ?io// Que remarque-t-on ? Est-ce le type et le résultat attendu ? Pourquoi ?io// Que remarque-t-on ? Est-ce le type et le résultat attendu ? Pourquoi ?io// Que remarque-t-on ? Est-ce le type et le résultat attendu ? Pourquoi ?io// Que remarque-t-on ? Est-ce le type et le résultat attendu ? Pourquoi ?io// Que remarque-t-on ? Est-ce le type et le résultat attendu ? Pourquoi ?io// Que remarque-t-on ? Est-ce le type et le résultat attendu ? Pourquoi ?io// Que remarque-t-on ? Est-ce le type et le résultat attendu ? Pourquoi ?io// Que remarque-t-on ? Est-ce le type et le résultat attendu ? Pourquoi ?io// Que remarque-t-on ? Est-ce le type et le résultat attendu ? Pourquoi ?io// Que remarque-t-on ? Est-ce le type et le résultat attendu ? Pourquoi ?io// Que remarque-t-on ? Est-ce le type et le résultat attendu ? Pourquoi ?io
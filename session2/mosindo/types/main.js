...
console.log( "mon prénom est.",firstName,typeof firstName);
console.log( "j'ai",typeNumber,"ans.",typeof typeNumber);
console.log( "football",likeFootball,".",typeof likeFootball);
...
//les chaines de caractere ne permette de faire des calcul de nombre,dans notre cas les Chaînes de caractères on été concaténé ensemble.

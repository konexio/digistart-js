...
console.log("Mon nom est " + "" +  firstName  + "" +" Type est " + "" +typeof firstName);
console.log("J'ai " + "" +  age  + ""+" Type est " + typeof age );
console.log("j'adore le football " + "" + likeFootball  + ""+" Type est " + ""  + typeof likeFootball);
console.log("Mon nom est " + "" +  firstName  + ""+ "" +" Type est "+ "" + typeof firstName);
console.log( otherStuff + "" +"  Type est " + "" + typeof otherStuff);

...
if (color1 === "rouge") {
    console.log("Color1 est une fraise");
}
else if (color1 === "vert") {
    console.log("Color1 est une pomme");
}
else {
    console.log("Color1 est rien du tout");
}

if (color2 === "rouge") {
    console.log("Color2 est une fraise");
}
else if (color2 === "vert") {
    console.log("Color2 est une pomme");
}
else {
    console.log("Color2 est rien du tout")
}

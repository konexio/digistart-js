...
// 1. Déclarer une variable student qui contient un objet avec les clé et valeurs suivantes :
// - name : Votre nom
// - age : Votre age
// - city: Votre ville
...
console.log(users[0].name); // user.name -> "john"

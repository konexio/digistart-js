...
random.splice(1, 1, 'toto');
// j'ai remplacé l'element avec toto mais ça n'a pas marché c'est quoi le problème?
...
// ------ TODO 5 ------
var array = ['Michael', 'Jordan', 'Laeticia', 'Julie', 'toto', 'Doucoure'];
...
function dernierElement(tableau) {
  ...
  var dernierIndice = longueurTableau - 1;
...
var resultat = dernierElement(array);

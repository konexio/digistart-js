...
// je me suis trompé :((( le tableau doit etre en parametre !
function argumentEnParametre(n1) {
  return n1[n1.length - 1]; //gg
}

var result = argumentEnParametre(array);
console.log(result);
console.log(result);

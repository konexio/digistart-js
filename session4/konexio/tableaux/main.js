...
console.log("prices element 3 : ", prices[3]);
...
console.log("Après avoir ajouté 0 : ", array);
...
function dernier_element(liste) {
...
console.log("Dernier element : ", dernier_element(array));

...
console.log("element in fourth position is : " + prices[3]);
...
random[4] = "B";// 1. En accédant aux éléments du tableau, remplacer un élément du tableau.




console.log(random);// 2. Afficher le tableau dans la console.
...
var array = [6, 23, 7, 937284848348, 0];
...
// ------ TODO 5 ------ 
var myArray = ["Michael", "Jordan", "Laeticia", "Julie", "kaoula", "mosindo", "toto", "titi"]; 

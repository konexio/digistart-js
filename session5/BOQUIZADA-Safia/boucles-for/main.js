...
for (var i = 0; i <= nombres.lenght; i++) {
    //  C'est un point virgule qu'il faut mettre ici et pas une virgule :)
...
for (var i = 2; i < nombres.lenght; i++) {
    console.log(nombres[i]);
}
// TODO: ÉTAPE 3
// Avec une autre boucle for, afficher dans la console toutes les valeurs
// du tableau `nombres`, une par une, sauf les trois dernières.
for (var i = 0; i < nombres.lenght - 3; 1++)
    // TODO: ÉTAPE 4
    // Avec une autre boucle for, afficher dans la console toutes les valeurs
...
for (var i = 0; i < prenoms.length; i++) {
    //  Y a une petite faute dans la variable :)
...
// y a une petite faute dans length 
for (var i = 3; i < prenoms.length - 2; i++) {

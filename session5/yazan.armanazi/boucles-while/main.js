...
var m = 0
while (prenoms[m].length <= 5) {
    console.log(prenoms[m]);
    m++;
}
// TODO: ÉTAPE 6
...
while (prenoms[d].includes ("a")|| prenoms[d].includes("A")) {
    console.log(prenoms[d]);
    d++

    //or
    //toLowerCase Method detect the two case (capital et small letter)
